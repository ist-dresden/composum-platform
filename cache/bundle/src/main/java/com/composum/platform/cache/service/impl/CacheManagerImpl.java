...
public class CacheManagerImpl implements CacheManager {
    ...
    @Override
    public <T extends Serializable> CacheService<T> getCache(String name, Class<T> type) {
        return instances.get(name);
    }

    @Override
    public Cache useCache(String name, CacheConfiguration config) {
    ...
    protected synchronized void addCacheService(final CacheService service) {
        LOG.info("addCacheService: {}", service.getName());
        instances.put(service.getName(), service);
    }

    protected synchronized void removeCacheService(final CacheService service) {
