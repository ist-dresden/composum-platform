...
public class ExceptionUtil {
     ...
     * please remember to declare the thrown exceptions on the method!
     * That'd look for example like:
     * <code>list.stream().map(ExceptionUtil.callAndSneakExceptions(Node::getPath).collect(Collectors.toList());</code>
     *
     * @param <T>      the type parameter
     * @param callable the callable
     * @return the result of calling the callable
    ...
    /**
     * Function that can throw exceptions. This is a @FunctionalInterface, but as of 2019-04-02 we are restricted to
     * Java 7 here.
     */
    @FunctionalInterface
